...
router.route('/medidaHoy').post(sensorController.medicionesHoyGet)

router.route('/comprobarPassword').post(sensorController.comprobarContraseña)
...
router.route('/cambiarPassword').put(sensorController.cambiarPassword)
